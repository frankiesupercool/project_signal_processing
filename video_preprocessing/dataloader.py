...
class AVSRDataLoader(object):
    ...
    def preprocess(self, video_pathname, landmarks):
        """preprocess.

        :param video_pathname: str, the filename for the video.
        :param landmarks: str, the filename for the landmarks.
        """
    ...
    def load_video(self, data_filename, landmarks=None):
        """load_video.

        :param data_filename: str, the filename for input sequence.
        :param landmarks: str, the filename for the landmarks of the target speaker.
        """
